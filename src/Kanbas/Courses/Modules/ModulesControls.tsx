...
export default function ModulesControls({ onCollapseAll, onExpandAll }: ModulesControlsProps) {
  return (
    <div id="wd-modules-controls" className="text-nowrap">
      ...
      <button id="wd-collapse-all" className="btn btn-lg btn-secondary me-1" onClick={onCollapseAll}>
        Collapse All
      </button>
      <button id="wd-expand-all" className="btn btn-lg btn-secondary me-1" onClick={onExpandAll}>
        Expand All
      </button>
    </div>
  );
